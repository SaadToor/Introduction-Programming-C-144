...
int main(void)
{
	...
	checkDigit=socialInsuranceNumber%10;
	...
	highNumber=(totalSplitTotal/10);
	checkTotal=(highNumber+1)*10;
	st=checkTotal-totalSplitTotal;
	...
	printf("Please enter your Soical Insurance Number or press 0 to quit:\n");
	scanf("%d",&socialInsuranceNumber);	
	}
